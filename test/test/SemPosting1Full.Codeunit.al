codeunit 123456760 "Sem. Posting (1) Full ASD"
{
    // [FEATURE][Seminar Management][Posting]

    // Full implementation of scenarios as defined in ATDD sheet for Seminar Posting including cleanup of existing data
    ...
    begin
        LibraryTestInitialize.OnTestInitialize(Codeunit::"Sem. Posting (1) Full ASD");
        ...
        LibraryTestInitialize.OnBeforeTestSuiteInitialize(Codeunit::"Sem. Posting (1) Full ASD");
        ...
        LibraryTestInitialize.OnAfterTestSuiteInitialize(Codeunit::"Sem. Posting (1) Full ASD");
    end;
